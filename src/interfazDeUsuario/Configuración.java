...
public class Configuración implements Serializable{
    ...
    public void guardarConfig(){
        try {
            BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\Compu\\Documents\\workspace\\Proyecto---BadIceCream\\src\\fuentes\\datosDeJuego\\configuración.txt"));
    ...
    public void cargarConfig(){
        try {
            BufferedReader br=new BufferedReader(new FileReader("C:\\Users\\Compu\\Documents\\workspace\\Proyecto---BadIceCream\\src\\fuentes\\datosDeJuego\\configuración.txt"));
            String s;
