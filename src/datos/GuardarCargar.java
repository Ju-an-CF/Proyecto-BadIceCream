...
public class GuardarCargar implements Serializable {
    ...
    public void guardar(Nivel nivel){
        ...
        try{
            ...
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File("C:\\Users\\Compu\\Documents\\workspace\\Clonación\\Proyecto---BadIceCream\\src\\datos\\fuentes\\datosDeJuego\\" + nivel.getNivel() + ".dat")));
    ...
    public void cargar(Nivel nivel){
        try {
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File("C:\\Users\\Compu\\Documents\\workspace\\Clonación\\Proyecto---BadIceCream\\src\\datos\\fuentes\\datosDeJuego\\" + nivel.getNivel() + ".dat")));
